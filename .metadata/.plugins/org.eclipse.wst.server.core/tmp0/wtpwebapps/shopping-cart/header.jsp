...
<body style="background-color: #ad2366">
	<!--Company Header Starting  -->
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #757171; color: white; padding: 5px;">
		<h2>CERAMIC CARE</h2>
		<h6>PRODUCER AND CONSUMER</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Raw Material Shopping Center</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=sand">SAND</a></li>
							<li><a href="index.jsp?type=clay">CLAY</a></li>
							<li><a href="index.jsp?type=quartz">QUARTZ</a></li>
							<li><a href="index.jsp?type=feldspar">FELDSPAR</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=sand">SAND</a></li>
							<li><a href="userHome.jsp?type=clay">CLAY</a></li>
							<li><a href="userHome.jsp?type=quartz">QUARTZ</a></li>
							<li><a href="userHome.jsp?type=feldspar">FELDSPAR</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=clay">CLAY</a></li>
							<li><a href="adminViewProduct.jsp?type=sand">SAND</a></li>
							<li><a href="adminViewProduct.jsp?type=quartz">QUARTZ</a></li>
							<li><a href="adminViewProduct.jsp?type=feldspar">FELDSPAR</a></li>
						</ul></li>
