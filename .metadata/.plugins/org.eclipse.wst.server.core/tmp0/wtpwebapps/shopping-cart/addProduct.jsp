...
<body style="background-color: #979c99;">
	<%
	...
	<div class="container">
		<div class="row"
			...
			<form action="./AddProductSrv" method="post"
				...
				style="border: 2px solid black; border-radius: 10px; background-color: #BAB5B4; padding: 10px;">
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: white;">Product Addition Form</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
